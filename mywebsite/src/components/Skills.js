...
function Skills() {
    return (
        <div className="flex flex-col items-center justify-center text-center p-6 from-gray-700 to-gray-900 bg-gradient-to-bl text-white shadow-2xl rounded-xl mx-5  mb-8 mt-5 flex-1 md:mb-8  md:w-[45%] md:-ml-1 sm:flex-initial">
